Page({
  data: { keyword: '', providerIdx: 0, providers: ['全部厂商'], sortBy: 'input', sortAsc: true, filteredList: [], lastUpdate: '' },
  ...
  onLoad: function() {
    ...
    setTimeout(function() {
      ...
      self.setData({ providers: ['全部厂商'].concat(Object.keys(provSet)), lastUpdate: pricingData.updateTime || '' })
      self.applyFilters()
    }, 50)
  },
  ...
  onSort: function(e) { var f = e.currentTarget.dataset.field; var a = this.data.sortBy === f ? !this.data.sortAsc : true; this.setData({ sortBy: f, sortAsc: a }); this.applyFilters() },
