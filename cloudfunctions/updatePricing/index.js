...
exports.main = async (event, context) => {
  ...
  return { code: 0, modelCount: models.length, isSeeded, scrapers: { deepseek: !errors.some(e=>e.startsWith('DeepSeek')), bailian: !errors.some(e=>e.startsWith('阿里百炼')), ctyun: !errors.some(e=>e.startsWith('天翼云')), google: !errors.some(e=>e.startsWith('Google')), siliconflow: !errors.some(e=>e.startsWith('硅基流动')) }, errors: errors.length ? errors : undefined }
}
